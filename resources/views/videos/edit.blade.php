...
<x-app-layout>
    <div class="p-4 flex flex-col	 items-center justify-center direc">
        ...
        <form class="flex flex-col gap-4" action="{{ route('videos.update', $video->id) }}" method="POST"
            ...
            <div>
                ...
                <div class="w-[400px] relative border-2 border-gray-300 border-dashed rounded-lg p-6" id="dropzone-img">
                    ...
                    <img src="{{ Storage::url($video->image_path) }}" class="mt-4 mx-auto max-h-40 " id="preview">
                </div>
            </div>
            <div class="mt-2">
                <button
